...
import com.example.demo.auth.infrastructure.jwt.JwtAuthenticationFilter;
...
import com.example.demo.auth.service.OAuth2SuccessHandler;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/", "/css/**", "/images/**", "/js/**", "/h2-console/**",
                    ...
                    "/api/oauth2/authorization/*", "/admin/**", "/actuator/health")
                .permitAll()
